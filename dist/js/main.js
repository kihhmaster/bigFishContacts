...
swiper__WEBPACK_IMPORTED_MODULE_1__.Swiper.use([swiper__WEBPACK_IMPORTED_MODULE_1__.Parallax, swiper__WEBPACK_IMPORTED_MODULE_1__.Mousewheel, swiper__WEBPACK_IMPORTED_MODULE_1__.Pagination, swiper__WEBPACK_IMPORTED_MODULE_1__.Scrollbar, swiper__WEBPACK_IMPORTED_MODULE_1__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_1__.Controller, swiper__WEBPACK_IMPORTED_MODULE_1__.Autoplay, swiper__WEBPACK_IMPORTED_MODULE_1__.FreeMode, swiper__WEBPACK_IMPORTED_MODULE_1__.Thumbs, swiper__WEBPACK_IMPORTED_MODULE_1__.EffectFade]);

// gsap.registerPlugin(ScrollTrigger);
gsap__WEBPACK_IMPORTED_MODULE_2__["default"].registerPlugin(gsap_MotionPathPlugin__WEBPACK_IMPORTED_MODULE_3__["default"]);
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  /// удалить при установки на сайт
  var prevScrollPos = window.pageYOffset;
  if (prevScrollPos < 50) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".header-top").removeClass("hidden-header-top");
  }
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scroll(function () {
    var currentScrollPos = window.pageYOffset;
    if (currentScrollPos > 50) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".header-top").addClass("active hidden-header-top");
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".header-top .black2-btn").addClass("red-btn");
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".header-top .green-border-btn2").addClass("black-bg-btn");
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".header-top .button-hover2").removeClass("green-border-btn2");
      if (prevScrollPos > currentScrollPos) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(".header-top").removeClass("hidden-header-top");
      } else {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(".header-top").addClass("hidden-header-top");
      }
      prevScrollPos = currentScrollPos;
    } else {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".header-top").removeClass("active hidden-header-top");
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".header-top .black2-btn").removeClass("red-btn");
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".header-top .green-border-btn2").removeClass("black-bg-btn");
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".header-top .button-hover2").addClass("green-border-btn2");
    }
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".black2-btn").on("click", function (e) {
    e.preventDefault();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).closest(".header-top").find(".menu-wrap").addClass("open");
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("body, html").addClass("overflow");
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".close-menu").on("click", function (e) {
    e.preventDefault();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).closest(".header-top").find(".menu-wrap").removeClass("open");
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("body, html").removeClass("overflow");
  });
  /// удалить при установки на сайт

  var contactsSlider;
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-contacts').each(function () {
    var _Swiper;
    var slider = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
    var contactsSlider = new swiper__WEBPACK_IMPORTED_MODULE_1__.Swiper(slider[0], (_Swiper = {
      // slidesPerView: 1,
      // spaceBetween: 16,
      loop: false,
      pagination: true,
      ...
      activeIndexChange: function activeIndexChange() {
        var workSliderDesc = document.querySelectorAll(".contacts__swiper");
        workSliderDesc.forEach(function (elem) {
          var idex = elem.swiper.realIndex;
  ...
  function startSlideOne() {
    ...
    var tlfish = gsap__WEBPACK_IMPORTED_MODULE_2__["default"].timeline({
      paused: false
    });
    var Title = gsap__WEBPACK_IMPORTED_MODULE_2__["default"].timeline({
      paused: false
    });
    var subTitle = gsap__WEBPACK_IMPORTED_MODULE_2__["default"].timeline({
      paused: false
    });
    var titleLine = gsap__WEBPACK_IMPORTED_MODULE_2__["default"].timeline({
      paused: false
    });
  ...
  function startSlideTwo(a) {
    var condition = a;
    var fishTwo = gsap__WEBPACK_IMPORTED_MODULE_2__["default"].timeline();
    var ramp = gsap__WEBPACK_IMPORTED_MODULE_2__["default"].timeline();
    fishTwo.clear();
    ramp.clear();
    gsap__WEBPACK_IMPORTED_MODULE_2__["default"].set("#ramp" + "#fishTwo", {
      clearProps: "all"
    });
    if (condition == false) {
      fishTwo.kill();
  ...
  function startSlideTitleTwo(a) {
    var condition = a;
    var TitleTwo = gsap__WEBPACK_IMPORTED_MODULE_2__["default"].timeline();
    var subTitleTwo = gsap__WEBPACK_IMPORTED_MODULE_2__["default"].timeline();
    var titleLineTwo = gsap__WEBPACK_IMPORTED_MODULE_2__["default"].timeline();
    TitleTwo.clear();
    subTitleTwo.clear();
    titleLineTwo.clear();
  ...
  function startSlideThree(a) {
    var condition = a;
    var fishTree1 = gsap__WEBPACK_IMPORTED_MODULE_2__["default"].timeline({
      paused: false
    });
    var fishTree2 = gsap__WEBPACK_IMPORTED_MODULE_2__["default"].timeline({
      paused: false
    });
    var fishTree3 = gsap__WEBPACK_IMPORTED_MODULE_2__["default"].timeline({
      paused: false
    });
    ...
    gsap__WEBPACK_IMPORTED_MODULE_2__["default"].set("#fishTree-1" + "#fishTree-2" + "#fishTree-3", {
      clearProps: "all"
    });
    if (condition == false) {} else startAnimationSlideTree();
  ...
  ;
  var jellyfishMouse = document.querySelector("#jellyfish");
  var jellyfish2Mouse = document.querySelector("#jellyfish2");
  var fish1Mouse = document.querySelector("#fish1");
  var fishTwoMouse = document.querySelector("#fishTwo");
  var rampMouse = document.querySelector("#ramp");
  var fishTreeMouse1 = document.querySelector("#fishTree-1");
  var fishTreeMouse2 = document.querySelector("#fishTree-2");
  var fishTreeMouse3 = document.querySelector("#fishTree-3");
  var fishFourMouse = document.querySelector("#fishFour-1");
  var octopusMouse = document.querySelector("#octopus");
  var hover10 = gsap__WEBPACK_IMPORTED_MODULE_2__["default"].to(octopusMouse, {
    x: 100,
    y: -100,
    duration: 1.5,
    paused: true,
  ...
  octopusMouse.addEventListener("mouseenter", function () {
    return hover10.play();
  });
  octopusMouse.addEventListener("mouseleave", function () {
    return hover10.reverse();
  });
  var hover9 = gsap__WEBPACK_IMPORTED_MODULE_2__["default"].to(fishFourMouse, {
    x: 100,
    y: -100,
    duration: 1.5,
    paused: true,
  ...
  fishFourMouse.addEventListener("mouseenter", function () {
    return hover9.play();
  });
  fishFourMouse.addEventListener("mouseleave", function () {
    return hover9.reverse();
  });
  var hover8 = gsap__WEBPACK_IMPORTED_MODULE_2__["default"].to(fishTreeMouse3, {
    x: 100,
    y: -100,
    duration: 1.5,
    paused: true,
  ...
  fishTreeMouse3.addEventListener("mouseenter", function () {
    return hover8.play();
  });
  fishTreeMouse3.addEventListener("mouseleave", function () {
    return hover8.reverse();
  });
  var hover7 = gsap__WEBPACK_IMPORTED_MODULE_2__["default"].to(fishTreeMouse2, {
    x: 100,
    y: -100,
    duration: 1.5,
    paused: true,
  ...
  fishTreeMouse2.addEventListener("mouseenter", function () {
    return hover7.play();
  });
  fishTreeMouse2.addEventListener("mouseleave", function () {
    return hover7.reverse();
  });
  var hover6 = gsap__WEBPACK_IMPORTED_MODULE_2__["default"].to(fishTreeMouse1, {
    x: 100,
    y: -100,
    duration: 1.5,
    paused: true,
  ...
  fishTreeMouse1.addEventListener("mouseenter", function () {
    return hover6.play();
  });
  fishTreeMouse1.addEventListener("mouseleave", function () {
    return hover6.reverse();
  });
  var hover5 = gsap__WEBPACK_IMPORTED_MODULE_2__["default"].to(rampMouse, {
    x: 100,
    y: -100,
    duration: 1.5,
    paused: true,
  ...
  rampMouse.addEventListener("mouseenter", function () {
    return hover5.play();
  });
  rampMouse.addEventListener("mouseleave", function () {
    return hover5.reverse();
  });
  var hover4 = gsap__WEBPACK_IMPORTED_MODULE_2__["default"].to(jellyfishMouse, {
    x: -100,
    y: 100,
    duration: 1.5,
    paused: true,
  ...
  fishTwoMouse.addEventListener("mouseenter", function () {
    return hover4.play();
  });
  fishTwoMouse.addEventListener("mouseleave", function () {
    return hover4.reverse();
  });
  var hover = gsap__WEBPACK_IMPORTED_MODULE_2__["default"].to(jellyfishMouse, {
    x: 100,
    y: 100,
    duration: 1.5,
    paused: true,
  ...
  jellyfishMouse.addEventListener("mouseenter", function () {
    return hover.play();
  });
  jellyfishMouse.addEventListener("mouseleave", function () {
    return hover.reverse();
  });
  var hover2 = gsap__WEBPACK_IMPORTED_MODULE_2__["default"].to(jellyfish2Mouse, {
    x: 50,
    y: 50,
    duration: 1,
    paused: true,
  ...
  jellyfish2Mouse.addEventListener("mouseenter", function () {
    return hover2.play();
  });
  jellyfish2Mouse.addEventListener("mouseleave", function () {
    return hover2.reverse();
  });
  var hover3 = gsap__WEBPACK_IMPORTED_MODULE_2__["default"].to(fish1Mouse, {
    x: -100,
    y: -100,
    duration: 1.5,
    paused: true,
  ...
  fish1Mouse.addEventListener("mouseenter", function () {
    return hover3.play();
  });
  fish1Mouse.addEventListener("mouseleave", function () {
    return hover3.reverse();
  });
  gsap__WEBPACK_IMPORTED_MODULE_2__["default"].set("#seaUrchin", {
    xPercent: -50,
    yPercent: -100,
    scale: 0
  });
  gsap__WEBPACK_IMPORTED_MODULE_2__["default"].set("#starfish", {
    xPercent: -50,
    yPercent: -100,
    scale: 0,
    rotate: 0
  ...
  window.addEventListener("mousemove", function (e) {
    gsap__WEBPACK_IMPORTED_MODULE_2__["default"].to("#seaUrchin", {
      duration: 0.5,
      overwrite: "auto",
      x: e.clientX,
      y: e.clientY,
    ...
    gsap__WEBPACK_IMPORTED_MODULE_2__["default"].to("#starfish", {
      duration: 0.5,
      overwrite: "auto",
      x: e.clientX,
      y: e.clientY,
    ...
    var seaUrchin = gsap__WEBPACK_IMPORTED_MODULE_2__["default"].timeline({
      defaults: {
        duration: 0.5,
        ease: "none",
        rotate: 0
    ...
    var starfish = gsap__WEBPACK_IMPORTED_MODULE_2__["default"].timeline({
      defaults: {
        duration: 0.5,
        ease: "none",
        rotate: 0
  ...
  function startSlideTitleThree(a) {
    var condition = a;
    var TitleThree = gsap__WEBPACK_IMPORTED_MODULE_2__["default"].timeline({
      paused: false
    });
    var subTitleThree = gsap__WEBPACK_IMPORTED_MODULE_2__["default"].timeline({
      paused: false
    });
    var titleLineThree = gsap__WEBPACK_IMPORTED_MODULE_2__["default"].timeline({
      paused: false
    });
    ...
    if (condition == false) {} else startAnimationTitleTree();
  ...
  function startSlideFour(a) {
    var condition = a;
    var fishFour1 = gsap__WEBPACK_IMPORTED_MODULE_2__["default"].timeline({
      paused: false
    });
    var octopus = gsap__WEBPACK_IMPORTED_MODULE_2__["default"].timeline({
      paused: false
    });
    var octopusTentacle = gsap__WEBPACK_IMPORTED_MODULE_2__["default"].timeline({
      paused: false
    });
    ...
    function startAnimationSlideTree() {
      ...
      octopusTentacle.to(".octopus__tentacle", _defineProperty({
        y: -5,
        x: 15,
        rotate: -5,
        repeat: -1,
  ...
  function startSlideTitleFour(a) {
    var condition = a;
    var TitleFour = gsap__WEBPACK_IMPORTED_MODULE_2__["default"].timeline({
      paused: false
    });
    var subTitleFour = gsap__WEBPACK_IMPORTED_MODULE_2__["default"].timeline({
      paused: false
    });
    var titleLineFour = gsap__WEBPACK_IMPORTED_MODULE_2__["default"].timeline({
      paused: false
    });
    ...
    if (condition == false) {} else startAnimationTitleFour();
